    ...
    <section className="py-24 bg-slate-900 rounded-[4rem] mx-6 mb-24 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-12 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {TOOLS.map((tool, i) => (
            <button key={i} className="group p-8 rounded-[2rem] bg-slate-800/50 border border-slate-700 hover:border-slate-500 hover:bg-slate-800 transition-all flex flex-col items-center text-center">
