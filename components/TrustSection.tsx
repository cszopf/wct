        ...
        <div className="mt-20 bg-slate-900 rounded-[4rem] p-10 lg:p-16 text-white flex flex-col lg:flex-row items-center gap-12 justify-between relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-6 w-full lg:w-auto relative z-10">
            <a 
              ...
              className="px-10 py-5 bg-white text-slate-900 rounded-full font-header font-black text-xs flex items-center justify-center gap-3 hover:bg-[#64CCC9] hover:text-white transition-all hover:shadow-2xl group"
            >
              READ LIVE REVIEWS
              <ExternalLink className="w-4 h-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
            </a>
            <button className="px-10 py-5 bg-slate-800 text-white rounded-full font-header font-black text-xs hover:bg-slate-700 transition-all border border-slate-700">
              WRITE A REVIEW
            </button>
          </div>
        </div>
